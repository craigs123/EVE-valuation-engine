...
if use_test_area:
    ...
    # Much smaller coordinates to get exactly 1000 hectares
    test_coordinates = [
        [14.99, 59.99],    # Southwest corner
        [15.01, 59.99],    # Southeast corner  
        [15.01, 60.01],    # Northeast corner
        [14.99, 60.01],    # Northwest corner
        [14.99, 59.99]     # Close the polygon
    ]
