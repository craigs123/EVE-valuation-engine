...
if use_load_saved_area:
    ...
    single_ecosystem_areas = {
        ...
        "🌱 Test area (Grassland)": {
            "coords": calculate_1000ha_coordinates(-15.0417, -39.9080),
            "description": "Brazilian Grassland (-15.04°S, 39.91°W) | Expected: Grassland ecosystem",
...
if st.session_state.get('use_test_area_zoom', False):
    ...
    if use_test_area_single:
        ...
        ecosystem_zoom_coords = {
            ...
            "🌱 Test area (Grassland)": (-15.0417, -39.9080),  # Minas Gerais, Brazil
