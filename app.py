...
tab1, tab2 = st.tabs(["🗺️  Select & Calculate", "📈  Results"])
...
with tab2:
    if not st.session_state.get("analysis_results"):
        ...
        <div class="info-card">
            ...
            Draw an area on the map in the <strong>Select &amp; Calculate</strong> tab,
            then click <strong>🚀 Calculate Ecosystem Value</strong>.
        </div>
        """, unsafe_allow_html=True)
...
with tab1:
    ...
    if analyze_button and st.session_state.selected_area:
        try:
            ...
            st.success("Analysis complete!")
            st.toast("📈 Results ready — click the **Results** tab to view.", icon="✅")
