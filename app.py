...
""", unsafe_allow_html=True)
st.markdown('<p style="text-align: center; font-weight: bold; color: #666; margin-top: 0.5rem;">Version: 2.9.4 - More information at <a href="https://eve-solutions.eu/" target="_blank" style="color: #0891b2; text-decoration: none;">https://eve-solutions.eu/</a></p>', unsafe_allow_html=True)
...
if use_load_saved_area:
    ...
    single_ecosystem_areas = {
        ...
        "🌱 Test area (Grassland)": {
            "coords": calculate_1000ha_coordinates(-15.11360, -39.89871),
            "description": "Brazilian Grassland (-15.11°S, 39.90°W) | Expected: Grassland ecosystem",
...
if st.session_state.get('use_test_area_zoom', False):
    ...
    if use_test_area_single:
        ...
        ecosystem_zoom_coords = {
            ...
            "🌱 Test area (Grassland)": (-15.11360, -39.89871),  # Minas Gerais, Brazil
